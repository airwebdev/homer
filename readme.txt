...
Tags: blocks, block editor, tooltip, popover, icons, emoji, screen reader, tool, format, toolbar, custom toolbar, toolbar buttons, typewriter, text change, animation, hidden, show more, spoiler, uppercase, underline, lowercase, special characters, chars
Contributors: homer29, airweb
...
1. Inline Icons library

2. Emoji library

3. Special characters library

4. Language attribute

5. Choose one of many types of text animation

6. Set text as many text values as you want to switch between

7. Change text colours

8. Use timeline option for better UX

9. Customizable text cursor

10. Apply new button content on hover

11. Edit animation options - speed, delays, etc.

12. Hidden text / Spoiler effect

13. Hidden text effect on frontend

14. Adding special characters 
